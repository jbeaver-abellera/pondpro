...
<body>
  <div class="form-container">
    ...
    <form action="operator-edit-consumables.php" method="POST">
  ...
  <div class="form-group">
    ...
    <button type="button" class="cancel-button" onclick="window.location.href='operator-inventory.php';">Cancel</button>
  </div>
</form>
