...
// Check if the user is logged in and is an operator
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $created_by_role = $_SESSION['role'];  // This should be 'operator' if the user is an operator
...
// Redirect to the operator inventory page
header("Location: operator-inventory.php");
exit();
?>
