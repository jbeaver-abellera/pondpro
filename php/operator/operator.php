    ...
    fetch('operator-delete-consumables.php', {
      ...
      .then((data) => {
        if (data.success) {
          ...
          // Remove the deleted row from the table without refreshing
          const row = document.querySelector(`#inventory-body tr td:first-child:contains('${productId}')`).parentElement;
