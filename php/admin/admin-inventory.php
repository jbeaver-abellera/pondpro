  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="admin-livestocks.php" class="nav-link">
...
<div id="addModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <h2>Add New Data</h2>
        <form action="admin-save-consumables.php" id="addProductForm" method="POST">
...
<script>
  ...
  window.location.href = 'admin-edit-consumables.php?id=' + productId;
}

function deleteRow(productId) {
  if (confirm("Are you sure you want to delete Product ID: " + productId + "?")) {
    // Send request to delete endpoint
    fetch('admin-delete-consumables.php', {
      method: 'POST',
