...
<head>
  <meta charset="UTF-8">
    ...
    <title>IT Admin - PondPro Aquafarms</title>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="admin-livestocks.php" class="nav-link nav-list-active">
...
<div class="inventory">
  ...
  <!-- MORTALITY<h2>Mortality Rate per Breed</h2>
...
<div id="addModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <form action="admin-save-livestocks.php" id="addProductForm" method="POST">
...
<script>
  ...
  window.location.href = 'admin-edit-livestocks.php?id=' + productId;
}
...
function deleteRow(productId) {
    ...
    fetch('admin-delete-livestocks.php', {
        method: 'POST',
        headers: {
...
function searchConsumables(searchTerm) {
  fetch('admin-search-consumables.php', {
    method: 'POST',
    headers: {
