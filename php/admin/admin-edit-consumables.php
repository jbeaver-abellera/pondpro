...
<body>
  <div class="form-container">
    ...
    <form action="admin-edit-consumables.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="date" id="expiration" name="expiration" value="<?php echo $result['expiration_date']; ?>">
  </div>

  <div class="form-group">
    <button type="submit">Save Changes</button>
    <button type="button" class="cancel-button" onclick="window.location.href='admin-inventory.php';">Cancel</button>
  </div>
</form>
