  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="manager-livestocks.php" class="nav-link">
...
<div class="inventory">
  <h2>Consumables Data</h2>
  <!-- Add New Consumables button -->
  <div class="add-button-container">
    <button id="add-new-consumables" class="add-btn">Add New Consumables</button>
  </div>
...
<div id="addModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <form action="manager-save-consumables.php" id="addProductForm" method="POST">
            ...
            <select id="usage" name="usage" required>
                <option value="Feeds">Fish Feeds and Supplement</option>
                <option value="Feeds">Water Treatment Chemicals</option>
                <option value="Crabs">Health Products</option>
                <option value="Crayfish">Spawning and Breeding Supplies</option>
                <option value="Crayfish">Monitoring and Testing Supplies</option>
                <option value="Crayfish">Cleaning Products</option>
                <option value="Crayfish">Fuel and Energy</option>
                <option value="Crayfish">Packaging Materials</option>
            </select>
...
<script>
  ...
  window.location.href = 'manager-edit-consumables.php?id=' + productId;
}

function deleteRow(productId) {
  if (confirm("Are you sure you want to delete Product ID: " + productId + "?")) {
    // Send request to delete endpoint
    fetch('manager-delete-consumables.php', {
      method: 'POST',
